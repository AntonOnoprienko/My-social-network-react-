	...
	return (
		<div className={classes.content}>
			<div className={classes.posts}>
				...
				<Post src='https://www.meme-arsenal.com/memes/a5dd2f55b36488a10172f4f84352846b.jpg' name='Виталик Шматько' message='Это будет собачья вписка' likesCount='0' />
				<Post src='https://meragor.com/files/styles//ava_800_800_wm/standoff_1q.png' name='Денис TitovGym'message='Приходите качать банки!' likesCount='3' />
